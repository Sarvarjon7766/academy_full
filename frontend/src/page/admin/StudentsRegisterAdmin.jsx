// src/pages/StudentsRegisterAdmin.jsx
...
import AddSubjectAdd from '../register/form/AddSubjectAdd'
import OtherCosts from '../register/form/OtherCosts'
import RoomAttachment from '../register/form/RoomAttachment'
import Shunchaki from '../register/form/Shunchaki'
import SubjectAdd from '../register/form/SubjectAdd'

const StudentsRegisterAdmin = () => {
			...
			<div className="max-w-6xl mx-auto">
				<div className="text-center mb-8">
					<h1 className="text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">
						Talabani Ro'yxatga Olish (Admin)
					</h1>
				</div>
							...
							<>
								{isHotel ? (
									<RoomAttachment
										...
										onCancel={() => {
											setIsHotel(false)
											showToast("Mehmonxona tanlanmadi")
										}}
									/>
								) : (
									<Shunchaki
...
export default StudentsRegisterAdmin