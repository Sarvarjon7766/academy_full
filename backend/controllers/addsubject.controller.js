const {create,getAll,update,deleted} = require('../services/addsubject.service')
...
class AddSubjectController{
	...
	async getAll(req,res){
		try {
			...
			if(datas.success){
				return res.status(200).json({success:true,subjects:datas.addSubjects})
			}
...
module.exports = new AddSubjectController()